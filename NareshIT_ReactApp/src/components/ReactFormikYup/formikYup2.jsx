// Similar to <FormYup /> but may demonstrate more advanced Yup features
//  (e.g., nested objects, arrays, or custom validation).
import { useState } from "react";
import { useFormik } from "formik";
import * as yup from "yup";

export function FormYup2(){    
